...
async def eap_options(request: web.Request) -> web.Response:
    ...
    bool:     A boolean
    file:     A file that the user must provide; for instance, a private key
              in PEM format, or a CA certificate (or zip of a CA chain)
    ...
    ```
    POST multipart/form-data // (because of uploading key and cert files)
    {
        ssid: "my-ssid",
        ...
        eap_config : {
            ...
            caCert: <file>,
            phase2CaCert: <file>,
            phase2ClientCert: <file>,
            phase2PrivateKey: <file>
